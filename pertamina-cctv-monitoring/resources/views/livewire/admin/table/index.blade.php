                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($data as $cctv)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $cctv->ip_address }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $cctv->building->name }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $cctv->room->name }}</td>
