                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        @foreach($cctvs as $cctv)
                                            <div class="bg-white p-3 rounded-lg border border-gray-200">
                                                <div class="flex items-center justify-between">
                                                    <div>
                                                        <div class="font-medium">{{ $cctv->name }}</div>
                                                        <div class="text-sm text-gray-600">{{ $cctv->room->name }}</div>
                                                    </div>
                                                ...
                                                @if($cctv->status === 'online')
                                                    <a href="{{ route('user.cctv.stream', $cctv) }}" 
                                                       target="_blank"
                                                       class="mt-2 inline-block px-3 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-700">
                                                        View Stream
                                                    </a>
                                                @endif
                                            </div>
                                ...
                                @else
                                    <div class="text-gray-500 text-center py-8">
                                        ...
                                        @else
                                            Select a building to view CCTV cameras
                                        @endif
                                    </div>
                                @endif
                            </div>
